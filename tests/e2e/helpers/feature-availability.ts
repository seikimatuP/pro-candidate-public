...
export class FeatureAvailability {
  ...
  async checkSearchField(): Promise<boolean> {
    try {
      ...
      console.log('❌ 検索フィールドチェックエラー:', error.message);
      return false;
    }
  }
  ...
  async checkPlayerManagement(): Promise<boolean> {
    try {
      ...
      console.log('❌ 選手管理機能チェックエラー:', error.message);
      return false;
    }
  }
  ...
  async checkDataAvailability(): Promise<boolean> {
    try {
      ...
      console.log('❌ データ可用性チェックエラー:', error.message);
      return false;
    }
  }
  ...
  async checkPagination(): Promise<boolean> {
    try {
      ...
      console.log('❌ ページネーションチェックエラー:', error.message);
      return false;
    }
  }
  ...
  async checkFilters(): Promise<boolean> {
    try {
      ...
      console.log('❌ フィルター機能チェックエラー:', error.message);
      return false;
    }
  }
  ...
  async checkStatisticsCards(): Promise<boolean> {
    try {
      ...
      console.log('❌ 統計カードチェックエラー:', error.message);
      return false;
    }
  }
