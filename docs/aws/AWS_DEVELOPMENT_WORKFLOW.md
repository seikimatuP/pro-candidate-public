...
- **dev環境**: AWS Lambda + S3 + API Gateway（認証無効・開発用）
...
# ProBaseballStack-prod.CognitoUserPoolId = ap-northeast-1_5m7pnXzt8
# ProBaseballStack-prod.CognitoClientId = 3vuipnf467d9q43k40fo480fdk
...
# prod環境固有設定確認
grep -r "ap-northeast-1_5m7pnXzt8" dist/assets/
# dist/assets/index-xyz789.js:cognitoUserPoolId:"ap-northeast-1_5m7pnXzt8"
